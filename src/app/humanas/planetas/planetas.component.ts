...
@Component({
  ...
  styleUrls: ['./planetas.component.css', '../shared/style.css']
})
export class PlanetasComponent implements OnInit {

  public literals: any;
  public formas: Puzzle[] = [ 
    { imagem: '../../../assets/humanas/planetas/ESTRELA.png', posicaoCorreta: 0 },
    { imagem: '../../../assets/humanas/planetas/LUA.png', posicaoCorreta: 3 },
    { imagem: '../../../assets/humanas/planetas/SOL.png', posicaoCorreta: 2 },
    { imagem: '../../../assets/humanas/planetas/TERRA.png', posicaoCorreta: 1 }
  ];
